...
namespace :benchmarks do
  ...
  task single_object_with_render: :environment do
    Benchmark.ips do |x|
      x.report 'jbuilder' do
        render(partial: 'movies/movie', formats: [:json], locals: { movie: movie })
      end
  ...
  task array_of_objects_with_render: :environment do
    Benchmark.ips do |x|
      ...
      x.report 'active_model_serializers' do
        render text: ActiveModel::Serializer::CollectionSerializer.new(movies, each_serializer: MovieSerializer).to_json
      end
  ...
  task array_of_objects_without_render: :environment do
    Benchmark.ips do |x|
      ...
      x.report 'active_model_serializers' do
        ActiveModel::Serializer::CollectionSerializer.new(movies, each_serializer: MovieSerializer).to_json
      end
